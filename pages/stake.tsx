import {
  ...
  const stakingContractAddress = "0x7A1F464b92B8EA61Cfe2dC4a52a76022B2A90aF8";
  ...
  const Stake: NextPage = () => {
    ...
    return (
      <div className={styles.container}>
        <h1 className={styles.h1}>Stake Your Devils</h1>
